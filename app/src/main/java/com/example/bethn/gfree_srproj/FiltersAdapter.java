...
public class FiltersAdapter extends ArrayAdapter<Filters> {
    ...
    public FiltersAdapter(Context context, List<Filters> filtersList) {
        ...
        this.filtersList = filtersList;
        this.layoutInflater = LayoutInflater.from(context);//should this be .from(getContext()) or (getActivity())??
    }
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        //reuse existing row view
            ...
            //NEVER CALL FILTERSVIEWHOLDER.SETTEXTVIEW
            //filtersViewHolder.setTextView(textView);
        ...
        textView.setText(filtersList.get(position).getName());
